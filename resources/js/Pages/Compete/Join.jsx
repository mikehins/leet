                    ...
                    <form onSubmit={submit} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="1234"
                                className="block w-full rounded-lg border border-warm bg-white px-6 py-4 text-center text-xl font-semibold uppercase tracking-widest placeholder:text-stone-400 focus:border-stone-500 focus:ring-2 focus:ring-warm"
                                autoComplete="off"
                            />
                            {errors.code && (
                        ...
                        <button
                            ...
                            className="w-full rounded-lg bg-coral px-8 py-4 text-base font-medium text-white  transition hover:bg-coral-hover disabled:opacity-50"
                        >
                            {t('compete.join')}
                        </button>
                    </form>
